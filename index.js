    ...
    'SetGramsOfProtein': function () {
        ...
        if (isNaN(gramsOfProtein)) {
            ...
            (function write(index) {ProteinTracker.putGramsOfProtein(userId, date, gramsOfProtein, function(err, result) {
                const cardTitle = index.t("SET_PROTEIN_CARD_TITLE", index.t("SKILL_NAME"), gramsOfProtein);
                const speechOutput = index.t('SET_PROTEIN_MESSAGE', gramsOfProtein);
...
const LANGUAGE_STRINGS = {
    'en-US': {
        translation: {
            ...
            HELP_MESSAGE: 'You can say add twenty grams of protein, set my protein count to zero, or, you can say exit... What can I help you with?',
            HELP_REPROMPT: 'What can I help you with?',
            STOP_MESSAGE: 'Goodbye!',
            ADD_PROTEIN_MESSAGE: "I\'ve added %s grams of protein to your log",
            ADD_PROTEIN_CARD_TITLE: "%s - %s grams added",
            SET_PROTEIN_MESSAGE: "I\'ve reset your protein count to %s grams",
            SET_PROTEIN_CARD_TITLE: "%s - count reset to %s grams",
